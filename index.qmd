...
Die Grundidee der lineare Regression ist in [diesem interaktiven Applet](https://www.geogebra.org/m/wDpDdS7g) veranschaulicht. Eine Abhängige Variable $y_i$ wird also in der Regressionsanlyse als normalverteilt mit bedingtem Erwartungswert $b_0 + b_1*x_i$ und $\sigma$ angenommen:
...
bain(mod5, "classtypereg = classtyperegA = classtypesmall; classtypereg < classtyperegA < classtypesmall")
```
